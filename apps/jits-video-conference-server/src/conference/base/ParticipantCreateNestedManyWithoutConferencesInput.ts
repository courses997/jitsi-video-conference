...
@InputType()
class ParticipantCreateNestedManyWithoutConferencesInput {
...
export { ParticipantCreateNestedManyWithoutConferencesInput as ParticipantCreateNestedManyWithoutConferencesInput };
